...
| [0019](0019-admission-control-architecture.md) | Admission control / resource protection architecture |
| [0020](0020-mvcc-gc-replicated-watermark.md) | MVCC garbage collection as replicated state, with a snapshot horizon |
| [0021](0021-storage-lifecycle-retention-and-scrub.md) | Storage lifecycle — retention, disk-pressure semantics, and integrity scrub |
